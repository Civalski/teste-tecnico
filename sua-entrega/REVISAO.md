...
É possível simular as respostas do ERP e do WMS para verificar se o código:
...
Esses testes mostram como o código se comporta em situações controladas. Porém, somente um teste com o ERP e o WMS reais pode confirmar como essas APIs funcionam na prática, incluindo paginação, novas tentativas após falhas (`retry`), tempo máximo de espera (`timeout`), autenticação e troca do token de acesso.
